...
+---------------------------------------------------+---------------------------------------------+
| **Student ID Numbers and Names of Group Members** | 1.  126761 - B- Virginia Wang'ang'a         |
+---------------------------------------------------+---------------------------------------------+
| **GitHub Classroom Group Name**                   | B                                           |
+---------------------------------------------------+---------------------------------------------+
| **Course Code**                                   | BBT4206                                     |
+---------------------------------------------------+---------------------------------------------+
...
The 20230412-20230719-BI1-BBIT4-1-Crop recommendation dataset is then loaded. The dataset and its metadata are available here: <https://www.kaggle.com/datasets/atharvaingle/crop-recommendation-dataset>
...
We then display the number of observations and number of variables. We have 101 observations and 100 variables .
...
```{r Your nine Code Chunk} # Confirmation of the presence of missing}
# Data Splitting ----
